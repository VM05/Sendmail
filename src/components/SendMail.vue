        ...
        rutFormatter(){
          this.rut = this.rut.replace(/[^kK0-9\_]/g, '');
            if (this.rut.length > 1) {
              this.rut = this.rut.substring(0, this.rut.length - 1) + '-' + this.rut.substring(this.rut.length - 1, this.rut.length);
              }
              if (this.rut.length > 5) {
                  this.rut = this.rut.substring(0, this.rut.length - 5) + '.' + this.rut.substring(this.rut.length - 5, this.rut.length);
              }
              if (this.rut.length > 9) {
                  this.rut = this.rut.substring(0, this.rut.length - 9) + '.' + this.rut.substring(this.rut.length - 9, this.rut.length);
              } 
        },
